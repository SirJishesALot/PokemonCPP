...
using namespace std;
// g++ -o pokemonGame.out -std=c++11 Player.cpp Pokemon.cpp Trainer.cpp Location.cpp pokemonDriver.cpp
...
void displayInstructions() {
    ...
    cout << underline << "Enter the number beside the option to choose that option." << reset << endl;
...
int main() {
    ...
    string playerName, pokemonChoice;
    ...
    while (instructions) {
        ...
        string choiceInstructions;
        getline(cin, choiceInstructions);
    ...
    while (run) {
                        ...
                        if (fightValue == 2) {
                            if (myLocation.player.getPokeBalls() > 0) {
                                ...
                                while (!capture) {
                                    ...
                                    cout << "   1. Yes" << endl;
                                    cout << "   2. No" << endl;
                                    string captureChoice;
                                    getline(cin, captureChoice);
        ...
        if (choiceMain == "1") {
            ...
            if (myLocation.player.getPokeBalls() < 5) {
                ...
                myLocation.viewMap();
                string buffer;
                cout << endl << underline << "Press any key followed by the return key to continue." << reset << endl;
                getline(cin, buffer);
                continue;
            }
        }
